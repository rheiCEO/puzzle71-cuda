# Puzzle #71 — deploy na vast.ai (prefiks `74`)

Zakres skanowania:

```
740000000000000000 … 74ffffffffffffffff
```

(w pełnym zapisie 256-bit: `…000000000000000000000000000000000000000000000740000000000000000`)
...
# opcjonalnie nadpisz zakres (domyślnie już 74…)
export START_HEX=740000000000000000
export END_HEX=74ffffffffffffffff
...
- **losowe** szukanie na **wszystkich GPU** w zakresie `74…`
...
- Pełne P71 to 2^70; prefiks `74` = 2^64 (64× mniejsza przestrzeń)
