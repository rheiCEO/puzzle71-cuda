...
Zmienne:
  PUZZLE71_RANGE_START  hex (domyślnie 2^70)
  PUZZLE71_RANGE_END    hex (domyślnie 2^71-1)
...
RANGE_START = int(os.environ.get("PUZZLE71_RANGE_START", "0x40000000000000000"), 16)
RANGE_END = int(os.environ.get("PUZZLE71_RANGE_END", "0x7ffffffffffffffff"), 16)
